...
public class ItemCodeDescriptionDrawer : PropertyDrawer
{
    ...
    {
        //Change the returned property height to be double to cater for the additional item code descripition
        //that we will draw
    ...
    {
        //Using BeginProperty / EndProperty on t he parent property means that prefab override logic works
    ...
    private string GetItemDescription(int itemCode)
    {
        ...
        so_itemList = AssetDatabase.LoadAssetAtPath("Assets/Scriptable Objects Assets/Item/so_ItemList.asset"
